 ...
 * 
 */
@WebServiceClient(name = "soapService", targetNamespace = "http://service/", wsdlLocation = "http://localhost:9090/service/soap?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:9090/service/soap?wsdl");
    ...
    public Soap getSoapPort() {
        return super.getPort(new QName("http://service/", "soapPort"), Soap.class);
    }
    ...
    public Soap getSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service/", "soapPort"), Soap.class, features);
    }
